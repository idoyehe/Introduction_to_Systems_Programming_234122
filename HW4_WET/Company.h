...
namespace mtm {
    namespace escaperoom {
        ...
        private:
            string name;
            string telephone;
            set<EscapeRoomWrapper *> all_rooms;
            set<EscapeRoomWrapper *>::iterator findRoom (const EscapeRoomWrapper &room) const;
        ...
        public:
            ...
            // @throws CompanyMemoryProblemException in case of room creation failure.
            void
            createScaryRoom(char *name, const int &escapeTime, const int &level,
            ...
            // @throws CompanyMemoryProblemException in case of room creation failure.
            void
            createKidsRoom(char *name, const int &escapeTime, const int &level,
                           const int &maxParticipants, const int &ageLimit);
            ...
            void
            removeEnigma(const EscapeRoomWrapper &room, const Enigma &enigma);
            ...
            // @throws : CompanyRoomNotFoundException in case that room doesnt exist in company.
            // @throws : CompanyRoomEnigmaNotFoundException in case enigma doesnt exist in room.
            void addItem(const EscapeRoomWrapper &room, const Enigma &enigma,
            ...
            void removeItem(const EscapeRoomWrapper &room, const Enigma &enigma,
                            const string &element);
            ...
            friend std::ostream &
            operator<<(std::ostream &output, const Company &company);
