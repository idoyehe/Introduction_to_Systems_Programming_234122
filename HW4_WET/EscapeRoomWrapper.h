...
namespace escaperoom {
    ...
    public:
        ...
        //Function add new enigma to the room enigmas vector.
        //
        void addEnigma(const Enigma& enigma);

        //Function remove exists enigma from the room enigmas vector.
        //@throws EscapeRoomNoEnigmasException in case the vector is empty
        //@throws EscapeRoomEnigmaNotFoundException in case
        // the enigma does NOT exist in the vector.
        void removeEnigma(const Enigma& enigma);

        //Function return the hardest exists enigma from the room enigmas vector.
        //@throws EscapeRoomNoEnigmasException in case the vector is empty
        Enigma getHardestEnigma() const;
        //Function return the room enigmas vector.
        //
        vector<Enigma>& getAllEnigmas();
        //return by const string that say it is "BASE_ROOM"
        //
        virtual const string getType() const;

        // copy the room to the heap using new allocation
        //
        // return pointer to the allocation to the heap
        virtual EscapeRoomWrapper* copyToHeap() const;
    private:
        EscapeRoom room_struct;
        vector<Enigma> room_enigmas;
    protected:
