...
namespace escaperoom{
    ...
    public:
        ...
        // @param numOfElements : the number of elements set to be 0
        ...
        //@throws EnigmaIllegalSizeParamException in case of set size
        // does not mach numofelements
        Enigma(const std::string& name, const Difficulty& difficulty,
        ...
        //Function that add the new element to the set of elements in the enigma
        //
        void addElement(const string& element);
        //Function that remove an element from the set of elements in the enigma
        //@throws EnigmaNoElementsException in case of set does not holds
        // that element
